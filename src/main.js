import './style.css';
const PROFILE = {"day":"Day030","title":"Split Compare Coach 1","display_name_ja":"2案比較メモ","one_sentence":"2つの案の違いを見やすくするためのツールです。","purpose_line_ja":"2つの案の違いを見やすくするためのツールです。","use_case_line_ja":"どちらにするか迷った時に使います。","how_it_works_line_ja":"2つの案を入れると、違いと決めやすいポイントが出ます。","core_action":"compare","family":"compare_choice","mechanic":"compare","input_style":"split_inputs","output_style":"split_diff","audience_promise":"decision_confidence","publish_hook":"重み付き評価で候補案の順位変化を比較できる計算ツール。（話題:GitHub Trending (A） を before_after 角度で見せる","engine":"weighted_compare","interaction_archetype":"compare","page_archetype":"split_view","output_shape":"split_view","state_model":"compare_state","core_loop":"split_inputs -> compare -> split_diff","component_pack":"split_view+split_diff","scaffold_id":"weighted_calculator","single_shot_text_generator":false};
